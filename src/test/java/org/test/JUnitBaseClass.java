...
import baseclass.test.Base;

public class JUnitBaseClass extends Base {
	
	static JUnitBaseClass ref = new JUnitBaseClass();
	...
	public void login() throws IOException, InterruptedException {
		...
		ref.changeData("Datas", 10, 0, attributeValue);
